...
var format_DipatiukurJatinangor_2 = new ol.format.GeoJSON();
var features_DipatiukurJatinangor_2 = format_DipatiukurJatinangor_2.readFeatures(json_DipatiukurJatinangor_2, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_DipatiukurJatinangor_2 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_DipatiukurJatinangor_2.addFeatures(features_DipatiukurJatinangor_2);
var lyr_DipatiukurJatinangor_2 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_DipatiukurJatinangor_2, 
                style: style_DipatiukurJatinangor_2,
                popuplayertitle: 'Dipatiukur-Jatinangor',
                interactive: true,
                title: '<img src="styles/legend/DipatiukurJatinangor_2.png" /> Dipatiukur-Jatinangor'
            });

lyr_GoogleSatellite_0.setVisible(true);lyr_gadm36_IDN_3_1.setVisible(true);lyr_DipatiukurJatinangor_2.setVisible(true);
var layersList = [lyr_GoogleSatellite_0,lyr_gadm36_IDN_3_1,lyr_DipatiukurJatinangor_2];
...
lyr_DipatiukurJatinangor_2.set('fieldAliases', {'Halte': 'Halte', 'latitude': 'latitude', 'longitude': 'longitude', 'Alamat': 'Alamat', 'Gambar': 'Gambar', });
...
lyr_DipatiukurJatinangor_2.set('fieldImages', {'Halte': 'TextEdit', 'latitude': 'TextEdit', 'longitude': 'TextEdit', 'Alamat': 'TextEdit', 'Gambar': 'ExternalResource', });
...
lyr_DipatiukurJatinangor_2.set('fieldLabels', {'Halte': 'inline label - always visible', 'latitude': 'hidden field', 'longitude': 'hidden field', 'Alamat': 'inline label - always visible', 'Gambar': 'no label', });
lyr_DipatiukurJatinangor_2.on('precompose', function(evt) {
